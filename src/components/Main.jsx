...
<h2>{dailyData.current.temp_c.toFixed(0)}<span>&deg;C</span>  {hourData[0].temp_c.toFixed(0)} <span>&deg;C</span> </h2>
<img src={dailyData.current.condition.icon} {...hourData[0].condition.icon} alt="Weather condition icon" className='weather__main-image'/>
</div>
